...
from PySide2.QtCore import QFile, QPointF, QRectF, QSize, Qt, Property
from PySide2.QtGui import QColor, QIcon, QPainter, QPainterPath, QPen
from PySide2.QtWidgets import QToolButton, QAbstractButton
...
class TitleBarButton(QAbstractButton):
    ...
    def __init__(self, parent=None):
        ...
        # icon color
        self._normalColor = QColor(50, 49, 49)
        self._hoverColor = QColor(79, 82, 84)
        self._pressedColor = QColor(79, 82, 84)

        # background color
        self._normalBgColor = QColor(50, 49, 49)
        self._hoverBgColor = QColor(79, 82, 84)
        self._pressedBgColor = QColor(79, 82, 84)
...
class MinimizeButton(TitleBarButton):
    ...
    def __init__(self, parent=None):
        ...
        self.setNormalBackgroundColor(QColor(50, 49, 49))
        self.setNormalColor(QColor(134, 134, 134))
        self.setHoverBackgroundColor(QColor(79, 82, 84))
        self.setPressedBackgroundColor(QColor(79, 82, 84))
