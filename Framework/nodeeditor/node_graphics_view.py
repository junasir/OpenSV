...
from PySide2.QtCore import Signal, QPoint, Qt, QEvent, QPointF, QRectF
from PySide2.QtGui import QPainter, QDragEnterEvent, QDropEvent, QMouseEvent, QKeyEvent, QWheelEvent
...
class QDMGraphicsView(QGraphicsView):
    ...
    def mouseDoubleClickEvent(self, event):
        ...
        if event.button() == Qt.LeftButton:
            self.double_click.emit(event.pos())
