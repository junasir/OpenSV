...
class Ju_Ui_Main(QObject):
    ...
    def _init_ui(self, Test=None):
        ...
        self.img_widget_tips(Test=Test)
    ...
    def init_dock(self, Test=None):
        ...
        Test.Dockable_5 = QDockWidget('Dockable5', Test)
        Test.Dockable_3.setTitleBarWidget(QWidget())
        Test.Dockable_4.setTitleBarWidget(QWidget())
        Test.Dockable_5.setTitleBarWidget(QWidget())
        ...
        Test.Dockable_5.setWidget(Test.img_show_widget)
        ...
        Test.Dockable_5.setMinimumWidth(100)
        ...
        Test.Dockable_5.setFloating(False)
        ...
        Test.Dockable_5.setFeatures(QDockWidget.NoDockWidgetFeatures)
        Test.addDockWidget(Qt.LeftDockWidgetArea, Test.Dockable_1)
        Test.addDockWidget(Qt.BottomDockWidgetArea, Test.Dockable_2)
        Test.addDockWidget(Qt.BottomDockWidgetArea, Test.Dockable_5)
    ...
    def img_widget_tips(self, Test=None):
        gridLayout_111 = QGridLayout(Test.img_show_widget)
        gridLayout_111.setSpacing(0)
        gridLayout_111.setObjectName(u"gridLa")
        gridLayout_111.setContentsMargins(0, 0, 0, 0)
        Test.label_img_bottom = QLabel()
        Test.label_img_bottom.setAlignment(Qt.AlignCenter)
        Test.label_img_bottom.setScaledContents(True)
        gridLayout_111.addWidget(Test.label_img_bottom, 0, 0, 1, 2)
        Test.label_img_bottom.setText("处理结果显示")
