...
from PySide2.QtCore import Signal, QRect, QLine, Qt
from PySide2.QtGui import QColor, QPen, QFont, QPainter
...
class QDMGraphicsScene(QGraphicsScene):
    ...
    def drawBackground(self, painter:QPainter, rect:QRect):
        ...
        try: painter.drawLines(*lines_light)                    # supporting PySide2
        except TypeError: painter.drawLines(lines_light)        # supporting PySide2

        painter.setPen(self._pen_dark)
        try: painter.drawLines(*lines_dark)                     # supporting PySide2
