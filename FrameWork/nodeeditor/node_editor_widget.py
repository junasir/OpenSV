...
from PySide2.QtGui import QBrush, QPen, QFont, QColor
from PySide2.QtWidgets import QWidget, QVBoxLayout, QApplication, QMessageBox, QLabel, QGraphicsItem, QTextEdit, QPushButton
...
class NodeEditorWidget(QWidget):
    ...
    def initUI(self):
        ...
        self.scene = self.__class__.Scene_class(log=self.user_logger)
