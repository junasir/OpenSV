...
from PySide2.QtCore import QSize, QSettings, QPoint
from PySide2.QtWidgets import QMainWindow, QLabel, QAction, QMessageBox, QFileDialog, QApplication, QWidget
...
class NodeEditorWindow(QWidget):
    ...
    def __init__(self, log=None):
        ...
        self.initUI()
        # self.nodeeditor = self.NodeEditorWidget_class(self)
        # self.nodeeditor.scene.addHasBeenModifiedListener(self.setTitle)
        # # self.setCentralWidget(self.nodeeditor)
        # # self.createStatusBar()
        # self.nodeeditor.s_d.connect(self.onEditDelete1)
        # # set window properties
        # # self.setGeometry(200, 200, 800, 600)
        # self.setTitle()
        # self.createNodesDock()
        # self.nodeeditor.s_d.connect(self.onEditDelete)
    ...
    def initUI(self):
        ...
        # create node editor widget  self.__class__.
        self.nodeeditor = self.NodeEditorWidget_class(self)
        self.nodeeditor.s_d.connect(self.onEditDelete1)
        self.nodeeditor.scene.addHasBeenModifiedListener(self.setTitle)
        # self.setCentralWidget(self.nodeeditor)
    ...
    def new_copy(self, widget):
        data = widget.scene.clipboard.serializeSelected(delete=False)
        str_data = json.dumps(data, indent=4)
        QApplication.clipboard().setText(str_data)
